...
#FINAL RMSE of 0.8828624 Which is above the target but still an acceptable result
...
#FINAL RMSE of 0.8564252 which is well below the target of <  0.86490

#Rated Items:
nrow(lim_valid)/nrow(validation)

#Unfortunately this method simply does not evaluate over 40% of the data . 
#This is poor therefore it is recommended that the RMSE of 0.8830696 be taken as it evalueated 100% of the data.
